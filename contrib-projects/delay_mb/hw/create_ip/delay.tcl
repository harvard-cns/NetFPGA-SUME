...
set_property -dict [list CONFIG.Full_Threshold_Assert_Value_wach {15} CONFIG.Empty_Threshold_Assert_Value_wach {14}] [get_ips delay_fifo]
set_property -dict [list CONFIG.Full_Threshold_Assert_Value_wrch {15} CONFIG.Empty_Threshold_Assert_Value_wrch {14}] [get_ips delay_fifo]
set_property -dict [list CONFIG.Full_Threshold_Assert_Value_rach {15} CONFIG.Empty_Threshold_Assert_Value_rach {14}] [get_ips delay_fifo]
set_property -dict [list CONFIG.Performance_Options {First_Word_Fall_Through}] [get_ips delay_fifo]
set_property -dict [list CONFIG.Input_Data_Width {449} CONFIG.Input_Depth {16}] [get_ips delay_fifo]
set_property -dict [list CONFIG.Reset_Pin {true}] [get_ips delay_fifo]
set_property -dict [list CONFIG.Output_Data_Width {449} CONFIG.Output_Depth {32768} CONFIG.Input_Depth {32768}] [get_ips delay_fifo]
